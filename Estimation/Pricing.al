...
codeunit 90000 "Estimation Pricing"
{
    ...
    begin
        ...
        if Est."Customer No." <> '' then begin
            //TODO: replace this with new pricing format
            //Customer Specific
            if SP.Get(BOM."Item No.", SP."Sales Type"::Customer, Est."Customer No.") then
                exit(SP."Unit Price");
            //Customer Price Group
            Cust.get(Est."Customer No.");
            //if Cust."Customer Price Group" <> '' then begin
            if SP.Get(BOM."Item No.", SP."Sales Type"::"Customer Price Group", Cust."Customer Price Group") then
                exit(SP."Unit Price");
            //end;

            //TODO: add ranked pricing thing here
